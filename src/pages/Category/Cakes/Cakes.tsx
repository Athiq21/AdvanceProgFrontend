...
const Cakes = () => {
    ...
    const [title, setTitle] = useState<string>("Cakes");
    ...
    const handleItemClick = (id: number, categoryTitle: string) => {
        ...
        setTitle(id !== 0 ? categoryTitle : "Cakes");
    };
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={2.5} >
                    ...
                    <SideBar
                        ...
                        onItemClick={(id: number) => handleItemClick(id, updatedData.find(item => item.id === id)?.name || "Cakes")} />
                </Grid>
